...
pdf("ancestryFreqt1.pdf",width=8,height=9)
par(mfrow=c(3,1))
...
## BFxCA t1 (early)
lf<-c(4,8,12,16,20)+20
cf<-c(3,7,11,15,19)+20
...
## BZxCA t1 (early)
lf<-c(3,8,12,16,20)+40
cf<-c(4,7,11,15,19)+40
...
pdf("chromAncestryFreqt1.pdf",width=6.5,height=7.3)
par(mfrow=c(3,1))
par(mar=c(4.5,5,2.5,.5))
